##################################################################################################
# Sensitivity analysis - varying external concentration
...
save(final.response.by.county,file = "/Volumes/SHAG/GeoTox/data/sensitivity_results_05_2_ext_conc.RData")
