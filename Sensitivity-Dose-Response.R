...
# Outputs
# save(uchems,file = "uchems_20211118.RData")
# save(inhalation.dose.by.county,file = "inhalation_dose_by_county_20211118.RData")
# save(age.by.county,file = "age_by_county_20211118.RData")
# save(obesity.by.county,file = "obesity_by_county_20211118.RData")
# save(cyp1a1_up.by.county,file = "CYP1A1_by_county_20211118.RData")
...
save(final.response.by.county,file = "sensitivity_dr2.RData")
...
write.csv(ivive.summary.df, "dr_ivive_summary_df2.csv")
####################################################################################################
#### DOSE RESPONSE ####
...
save_plot("sensitivity.dr.hq.figure2.tif", sensitivity.dr.hq.figure, width = 40, height = 30, dpi = 200)
